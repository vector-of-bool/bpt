...
def gen_task_json_data() -> Dict[str, Any]:
    dagon_exe = paths.find_exe('dagon')
    assert dagon_exe, 'Unable to find the dagon executable. This command should be run in a Poetry'
