...
Addionally, while prebuilt ``bpt`` executables are `available on the GitHub page
<releases>`_, one may wish to build ``bpt`` from source.

.. _releases: https://github.com/vector-of-bool/bpt/releases
